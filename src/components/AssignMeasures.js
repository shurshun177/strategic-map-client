...
class AssignMeasures extends Component {
  ...
  cancelChanges = () => {
    ...
    if (typeof (this.props.allMeasures) === 'Array'){
  ...
  addAssignee = () => {
    let { currentAssignedMeasures, currentUnassignedMeasures, selectedUser } = this.state;
  ...
  removeAssignee = () => {
    let { currentAssignedMeasures, currentUnassignedMeasures, selectedAssignee } = this.state;
